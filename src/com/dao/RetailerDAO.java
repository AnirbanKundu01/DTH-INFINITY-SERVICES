...
public class RetailerDAO {
	...
	{
		String sql = "create table Employee (id number, name varchar(30), Email varchar(30), Phone1 number, Phone2 number, Address1 varchar(30), Address2 varchar(30), PIN number(8), city varchar(30), State varchar(30), SetTopBoxLimit number(4), creditLimit number(8), InventoryCost number(8), ServicesCharge number(8), percentGoodsSale number(8), Creation DATE";
